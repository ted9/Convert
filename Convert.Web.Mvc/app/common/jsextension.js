...
*/
    ...
    Array.prototype.first = function (conditionFnc) {
        conditionFnc = conditionFnc || function () { };
        var result;
        this.some(function (item) {
            if (conditionFnc(item) === true) {
                result = item;
                return true;
            }
    ...
    Array.prototype.firstOrDefault = function (conditionFnc) {
        var item = this.first(conditionFnc);
        return item || {};
    };
    ...
    */
    ...
    String.prototype.contain = function (textToSearch) {
        return this.indexOf(textToSearch, 0) > -1;
    };
    ...
    */
    ...
    Date.prototype.diffDays = function (date) {
        var ndays = (this.getTime() - date.getTime()) / 86400000;
